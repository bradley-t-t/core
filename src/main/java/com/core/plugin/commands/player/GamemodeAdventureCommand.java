...
public final class GamemodeAdventureCommand extends BaseCommand {

    public GamemodeAdventureCommand(CorePlugin plugin) {
        super(plugin);
    }
    ...
    protected void execute(CommandContext context) {
        ...
        GamemodeCommand.applyGamemode(context, target, GameMode.ADVENTURE);
    }

...
public final class GamemodeSurvivalCommand extends BaseCommand {

    public GamemodeSurvivalCommand(CorePlugin plugin) {
        super(plugin);
    }
    ...
    protected void execute(CommandContext context) {
        ...
        GamemodeCommand.applyGamemode(context, target, GameMode.SURVIVAL);
    }
